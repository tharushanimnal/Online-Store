...
?>
            ...
            <!-- cart item -->
                <div class="col-12 border border-3 rounded-5 p-3 mb-2 d-flex justify-content-between bg-body-secondary">
            ...
            ?>
               ...
               <div class="d-flex flex-column align-items-end">
                    <h6>Number of Item: <span class="text-info"><?php echo $num ?></span></h6>
                    <h5>Delivary Fee: <span class="text-info">Rs: 500.00</span></h5>
